...
MiddleGrid.prototype = {
  ...
  getX: function(idx) {
    return this.mosaic.width / this.mosaic.cols * this.mosaic.getCellX(idx) * this.mosaic.scale + this.offsetX(1);
  },

  getY: function(idx) {
    return this.mosaic.height / this.mosaic.rows * this.mosaic.getCellY(idx) * this.mosaic.scale + this.offsetY(3);
  },
